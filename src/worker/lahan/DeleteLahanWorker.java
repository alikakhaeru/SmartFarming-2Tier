...
public class DeleteLahanWorker extends SwingWorker<Void, Void> {

    private final LahanService service;
    private final LahanPanel panel;
    private final Lahan lahan;

    public DeleteLahanWorker(LahanService service, LahanPanel panel, Lahan lahan) {
